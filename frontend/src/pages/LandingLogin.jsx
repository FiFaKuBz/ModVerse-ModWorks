  ...
  return (
    <div className="min-h-screen bg-mOrange text-white">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-20 flex flex-col items-center text-center">
        ...
        <p className="text-sm text-orange-50/90 max-w-prose mb-10 font-athiti font-bold">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-lg text-neutral-900">
          <div className="flex flex-col items-center">
            ...
            <div className="w-28 h-28 rounded-2xl grid place-items-center bg-neutral-100">
              <img
            ...
            <button
              type="button"
              className="mt-8 inline-flex items-center justify-center gap-2 rounded-md border border-neutral-300 px-6 py-3 text-sm font-anuphan font-semibold text-neutral-800 hover:bg-neutral-50 active:scale-[.99] transition"
            >
