...
const savedProjects = [
  ...
  if (activeTab === "Saved") projectsToShow = savedProjects;
  if (activeTab === "Recruiter Requests") projectsToShow = recruiterRequests;
  ...
  return (
    <div className="relative min-h-screen bg-white text-gray-900">
      ...
      <div className="w-full max-w-[1600px] mx-auto px-[clamp(1rem,4vw,5rem)]">
        ...
        <ProfileStats followers={profile.followers} following={profile.following} />
        ...
        <div className="mt-8 pt-8">
          ...
          >
            {Array.isArray(projectsToShow) && projectsToShow.length > 0 ? (
              projectsToShow.map((project, idx) => <ProjectCard key={idx} project={project} />)
            ) : (
